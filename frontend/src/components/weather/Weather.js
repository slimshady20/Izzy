    ...
    componentDidMount() {
        window.navigator.geolocation.getCurrentPosition(
            position => {
                ...
                fetch(
                    `https://api.openweathermap.org/data/2.5/weather?lat=${position.coords.latitude}&lon=${position.coords.longitude}&exclude=hourly,daily&appid=29c14691581083f0d3dbd32a2c5e2f38&units=metric`
                )
                    .then(res => {
                        return res.json();
                    })
